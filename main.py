...
if __name__ == '__main__':
    ...
    # Reproducibility: seed from RUN_SEED env (multi-seed driver) or config 'seed'.
    seed_default = int(conf['seed']) if conf.contain('seed') else 2024
    seed = int(os.environ.get('RUN_SEED', seed_default))
    set_seed(seed)
